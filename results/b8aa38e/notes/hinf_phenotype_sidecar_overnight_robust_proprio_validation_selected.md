...
|---|---:|---|
| evaluation_diagnostics | available | results/b8aa38e/notes/gru_evaluation_diagnostics_overnight_robust_proprio_validation_selected.json |
| exact_audit | missing | source not provided |
| feedback_ablation | available | results/b8aa38e/notes/gru_feedback_ablation_overnight_robust_proprio_validation_selected.json |
| induced_gain | missing | source not provided |
| map_error_decomposition | available | results/b8aa38e/notes/gru_map_error_decomposition_overnight_robust_proprio_validation_selected.json |
| objective_comparator | available | results/b8aa38e/notes/objective_comparator_overnight_robust_proprio_validation_selected.json |
| perturbation_response | available | _artifacts/b8aa38e/notes/gru_perturbation_response_overnight_robust_proprio_validation_selected_manifest.json |
| standard_certificate | available | results/b8aa38e/notes/gru_standard_certificates_overnight_robust_proprio_validation_selected_manifest.json |
