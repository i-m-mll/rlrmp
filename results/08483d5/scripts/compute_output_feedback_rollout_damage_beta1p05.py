...
JSON_PATH = OUT_DIR / "output_feedback_damage_estimate_beta1p05.json"
MD_PATH = OUT_DIR / "output_feedback_damage_estimate_beta1p05.md"
...
def _markdown(payload: dict[str, Any]) -> str:
    ...
    if failed:
        ...
        lines.append(
            "- Recomputed live geometry arrays match the stored beta-1.4 teacher package "
            "at rtol/atol 1e-9; beta-specific H-infinity arrays were recomputed live."
        )
    lines.append("")
    return "\n".join(lines)
