...
split plus notes-convention conversion) was dispatched and completed
2026-07-03, pending integration on feature branches. The pipeline-alignment
design lane (`e1ad278`, training → eval → analysis → report / eval-stage
extraction) is filed and blocks the remaining materializer-tail work.
