...
- Velocity plots (HTML, not committed): `_artifacts/part2_5/runpod/baseline_jerk_vrnn_matrix/` (forward + lateral velocity profiles)
- Model checkpoints: `_artifacts/part2_5/runpod/baseline_jerk_vrnn_matrix/<label>/`
