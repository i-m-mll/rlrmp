...
def materialize_figure(
    *,
    ...
    fig.update_layout(
        title="b413 beta 1.4 nominal forward velocity profiles",
...
def build_spec(*, robust_context: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema_version": "rlrmp.b413_beta1p4_nominal_velocity_profiles.v1",
        "issue": ISSUE,
        "figure_kind": "beta1p4_nominal_forward_velocity_profiles",
