...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --output-dir _artifacts/efc4d68/runs/baseline_gru__none
...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --output-dir _artifacts/efc4d68/runs/baseline_gru__smooth
...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --checkpoint --fused --no-streaming-loss \
  --output-dir _artifacts/efc4d68/runs/baseline_gru__jerk
...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --checkpoint --fused --no-streaming-loss \
  --output-dir _artifacts/efc4d68/runs/baseline_gru__smooth_jerk
...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --nn-hidden-derivative 0.0 --nn-output-jerk 0.0 --seed 42 \
  --checkpoint --fused --streaming-loss \
  --output-dir _artifacts/efc4d68/runs/baseline_vrnn__none
...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --nn-hidden-derivative 1e-3 --nn-output-jerk 0.0 --seed 42 \
  --checkpoint --fused --no-streaming-loss \
  --output-dir _artifacts/efc4d68/runs/baseline_vrnn__smooth
...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --nn-hidden-derivative 0.0 --nn-output-jerk 1e5 --seed 42 \
  --checkpoint --fused --no-streaming-loss \
  --output-dir _artifacts/efc4d68/runs/baseline_vrnn__jerk
...
uv run --no-sync python scripts/train_minimax.py --n-warmup-batches 12000 \
  ...
  --nn-hidden-derivative 1e-3 --nn-output-jerk 1e5 --seed 42 \
  --checkpoint --fused --no-streaming-loss \
  --output-dir _artifacts/efc4d68/runs/baseline_vrnn__smooth_jerk
```
...
- Sibling A/B: `results/efc4d68/notes/`.
