...
|---|---:|---|
| evaluation_diagnostics | available | results/b35595c/notes/gru_evaluation_diagnostics_calibrated_perturb_level_screen_feedback_selected_corrected.json |
| exact_audit | missing | source not provided |
| feedback_ablation | available | results/b35595c/notes/gru_feedback_ablation_calibrated_perturb_level_screen_feedback_selected_corrected.json |
| induced_gain | missing | source not provided |
| map_error_decomposition | available | results/b35595c/notes/gru_map_error_decomposition_calibrated_perturb_level_screen_feedback_selected_corrected.json |
| objective_comparator | available | results/b35595c/notes/objective_comparator_calibrated_perturb_level_screen_feedback_selected_corrected.json |
| perturbation_response | available | results/b35595c/notes/gru_perturbation_response_calibrated_perturb_level_screen_feedback_selected_corrected_manifest.json |
| standard_certificate | available | results/b35595c/notes/gru_standard_certificates_calibrated_perturb_level_screen_feedback_selected_corrected_manifest.json |
