...
- Cross-method comparison: [`results/c723082/notes/induced_gain_cross_method_comparison.md`](../../induced_gain_flavor_b/cross_method_comparison.md)
- Source training: issue `c723082`
- Source analyser: issue `74bfd86` (this issue)
- First-run flavor-A baselines: `results/c723082/notes/induced_gain_first_run.md`
