...
The analytical replay/audit and teacher-fit representational paths are in place, but naive objective-gradient training of the clean LQR gain did not meet the predeclared gain/objective pass band from zero initialization.
...
- Best objective: `341.99729`.
- Reference objective: `315.49776`.
- Objective ratio: `1.0839928`.
- Gain relative error: `0.98965567`.
- Canonical clean cost: `4638.0186`.
- Canonical peak forward velocity: `0.7275051`.
- Canonical terminal error: `0.0033697862`.
...
| `gradient_lqr_fit` | 4638.0186 | +1.4327% | 0.989656 | 5654.4856 | 50 | 0.00336979 |
