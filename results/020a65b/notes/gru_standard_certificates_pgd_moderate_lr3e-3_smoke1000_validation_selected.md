...
|---|---|---:|---:|---:|---|---|---|---|
| target_relative_multitarget_fullqrf_warmcos__pgd_moderate_lr3e-3_clip5_b64__nominal_clean | partial_standard_certificate_blocked | 1.91501 | 1.0174 | 0.998412 | not_applicable | not_applicable | not_applicable | mixed |
