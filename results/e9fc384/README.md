...
Retroactive structural fidelity audit of the original 38 tracked archived Feedbax
...
sidecars were known-wrong — they encoded the point-mass shape but should encode
...
Issue `b6b5502` retired the two known-wrong `30f2313` subjects with the tagged
legacy stock. The live guarded manifest now contains the 36 surviving clean
sidecars; this narrative retains the original 38-file audit disposition as
historical evidence.
