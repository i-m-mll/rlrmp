...
- ``ratio`` plateau ~1.21 at long horizons rather than 1.5: this is just
  ...
  gamma_PI by < 0.1% at qf_scale=1.0 (see
  results/72fb8d9/scripts/diag_probe_anomalies.py).
...
from rlrmp.analysis.math.hinf_riccati import (  # noqa: E402
    CostSchedule,
    CostSpec,
...
from rlrmp.analysis.math.induced_gain import (  # noqa: E402
    W_ADDITIVE_FORCE,
    Z_QR_COST,
    induced_gain_power_iteration,
...
def main():
    ...
    print("Plant: mass=1.0, damping=10.0, tau=0.05, dt=0.01")
    print("Controller: H-inf at gamma_design = 1.5 * gamma*")
    print("Analyser: power_iteration, qr_cost x additive_force")
    print("=" * 70)
