...
`results/2ef67ca/README.md` and `results/b557d4e/synthesis_review.md`. For
...
`results/b557d4e/synthesis_review.md` §2 for the verification. (Confirmed
...
`results/c723082/notes/induced_gain_first_run.md`, where
...
policy. The synthesis review prediction (`results/b557d4e/synthesis_review.md`
§6) is that:
...
2.5** (no umbrella; artifacts `results/2ef67ca/README.md` and
`results/b557d4e/synthesis_review.md`) was the perturbation-training and
...
Source: `results/b557d4e/synthesis_review.md` §2 + analyses coord `4d38c15`
...
- Hyperparameters: `results/72fb8d9/runs/<run>/run.json` per the
...
`results/c723082/runs/induced_gain_flavor_b.json` (+ `notes.md`); the
...
Run record: `results/c723082/runs/peak_velocity_flavor_b.json`.
Comparison doc: `results/c723082/notes/peak_velocity_cross_method_comparison.md`.
...
- Whether LEQG (Whittle 1981 / Jacobson 1973 risk-sensitive control,
  cumulant-tilt formulation; cited in `results/b557d4e/synthesis_review.md`
...
- Phase artifacts: `results/2ef67ca/README.md`,
  `results/b557d4e/synthesis_review.md`,
  `results/c723082/notes/induced_gain_first_run.md`.
