...
SCHEMA_VERSION = "rlrmp.guided_distillation.training_entry.v2"
ISSUE_ID = "9727d79"
...
def build_distillation_spec(args: argparse.Namespace) -> dict[str, Any]:
    ...
    args = argparse.Namespace(
        **GuidedDistillationConfig.model_validate(vars(args)).model_dump(mode="python")
    )
    ...
    spec = {
        ...
        "training_entry": {
            ...
            "loss_module": "rlrmp.train.distillation_native.losses",
            "loss_function": "rlrmp.train.distillation_native.losses.guided_distillation_loss",
        ...
        "teacher_bank": {
            "materializer": ("rlrmp.train.distillation_native.guided.materialize_teacher_batch"),
...
def _train_step(
    ...
    from rlrmp.train.distillation_native.executor import guided_distillation_train_step
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.set_defaults(**GuidedDistillationConfig().model_dump(mode="python"))
    return parser
