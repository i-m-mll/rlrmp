...
tangling_violins = (
    ...
    .then_transform_figs(partial(set_axis_bounds_equal, "y"), level_to_tuple_arg="train__pert__std")
)
...
ANALYSES = {
    ...
    #             fns=rnn_fns,
    #             fn_args=GradArgs(rnn_inputs, rnn_states),
    #         ),
