...
from rlrmp.analysis.gru_perturbation_bank import summarize_perturbation_response
...
def _numpy_rollout_evaluation(jax_eval: JaxRolloutEvaluation, trial_specs: Any) -> Any:
    ...
    from rlrmp.analysis.gru_pilot_figures import initial_effector_velocity
