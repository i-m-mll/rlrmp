...
**TODO**: We can probably move this back down to where the rest of the task setup is done
...
filter_pattern = f"1-1_*{MODEL_FILE_LABEL}*"
...
replicate_info_filepath = load(
    replicate_info_filepath, setup_replicate_info,
)
