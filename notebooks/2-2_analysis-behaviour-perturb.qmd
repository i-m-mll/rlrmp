...
from rnns_learn_robust_motor_policies.part2_setup import setup_models, TrainStdDict
...
```{python}
# TODO
# TODO: Use `TrainStdDict` from the start in `1-1`/`part1_setup`, and then `tree_map` over `TrainStdDict` 
# leaves in `part1_post_training`, which can then just be `post_training`
# TODO
