...
model_info = get_model_record(
    ...
    n_batches=10000,
    # disturbance_stds=[0.0, 0.5, 1.0, 1.5],
    disturbance_stds=[0.0, 0.0025, 0.025, 0.25, 2.5],
...
disturbance_train_stds = [
    x for x in model_info.disturbance_stds if x < 1.6 or x > 0
]
...
figs = {
    measure_key: {
        ...
        for variant_label in model_info.training_methods
    }
...
for measure_key in figs:
    figs[measure_key]['amplitude'].show()
```
