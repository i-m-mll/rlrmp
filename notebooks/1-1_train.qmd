...
if disturbance_type == 'curl':
    disturbance_stds = [0, 0.4, 0.8, 1.6, 2.4]
    ...
    disturbance_stds = [0, 0.01, 0.1, 1.0, 2.0]
...
task_model_pairs = {
    disturbance_std: schedule_intervenor(
        task_train, models,
...
for disturbance_std, (task_, models_) in tqdm(task_model_pairs.items()):
