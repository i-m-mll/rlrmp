...
n_batches = 10000  # training iterations
batch_size = 250
learning_rate_0 = 0.01
constant_lr_iterations = 1000  # Number of initial training iterations to hold lr constant
...
training_hyperparameters = dict(
    ...
    training_methods=list(task_model_pairs.keys()),
    p_perturbed=p_perturbed,
)
```
