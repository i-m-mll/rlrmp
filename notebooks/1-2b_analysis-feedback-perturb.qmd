...
if not load_from_parameters:
    ...
    models_filepath = str(find_unique_filepath(MODELS_DIR, f"1-1__{suffix_load}__{model_file_label}"))
...
```{python}
hyperparameters_filepath = models_filepath.replace(f'{model_file_label}.eqx', 'hyperparameters.json')
...
def get_violins_comparing_amplitudes(measure_data, measure_name, pert_var, annotation_kws=None, layout_kws=None):
    ...
    plot_disturbance_train_stds = [0, 0.8, 1.6]   
