...
from feedbax._tree import tree_key_tuples, tree_unstack, make_named_tuple_subclass
...
impulse_xy_conditions = dict.fromkeys(pert_var_names, dict.fromkeys(coord_names))
