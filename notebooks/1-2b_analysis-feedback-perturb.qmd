...
from rnns_learn_robust_motor_policies.setup_utils import display_model_filechooser
```
...
from feedbax._tree import istype
...
all_controls_imp = jt.map(
    lambda states: states.net.output[..., impulse_start_step:, :],
    all_states_imp,
    is_leaf=is_module,
)
