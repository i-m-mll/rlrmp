...
replicate_info_filepath = models_filepath.replace(f'{MODEL_FILE_LABEL}.eqx', '{REPLICATE_INFO_FILE_LABEL}.json')
replicate_info = load(replicate_info_filepath, setup_replicate_info)
...
```{python}
included_replicates = replicate_info['included_replicates']
best_replicate = replicate_info['best_replicate_by_loss']
