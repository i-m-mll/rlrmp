...
```{python}
context_inputs = [-1., -0.5, 0., 0.5, 1., 1.5]
...
**TODO**: hoverinfo should show PC1, PC2, PC3 and not x, y, z; also it should show time
**TODO**: Plot readout vectors 
...
fig = fbp.plot_traj_3D(
    fps_pc['states'][context_idx, ::stride_plot], 
    colors=conditions_colors[::stride_plot], 
    mode='markers', 
    marker_size=2, 
...
fig = fbp.plot_traj_3D(
    hidden_pc[context_idx, ::stride_plot], 
    colors=conditions_colors[::stride_plot], 
    mode='lines', 
    line_width=2,
